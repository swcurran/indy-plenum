...
- Exact format of each transaction can be found in [Indy Node Transactions](https://github.com/hyperledger-indy/indy-node/blob/master/docs/source/transactions.md).
